...
public class ViewUtils {
    ...
    public static void doOnApplyWindowInsets(
        ...
        final ViewUtils.RelativePadding initialPadding =
                new ViewUtils.RelativePadding(
        ...
        ViewCompat.setOnApplyWindowInsetsListener(
                ...
                new androidx.core.view.OnApplyWindowInsetsListener() {
                    ...
                    public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat insets) {
                        return listener.onApplyWindowInsets(view, insets, new ViewUtils.RelativePadding(initialPadding));
                    }
                });
        // Request some insets.
